...
public class ActivationContext {
    ...
    public void setAbly(PubSubHttpClient ably) {
        this.ably = ably;
    ...
    public static ActivationContext getActivationContext(Context applicationContext, PubSubHttpClient ably) {
    ...
    protected PubSubHttpClient ably;
