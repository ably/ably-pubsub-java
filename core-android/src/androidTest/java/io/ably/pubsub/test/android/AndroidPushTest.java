...
import io.ably.pubsub.push.ActivationContext;
import io.ably.pubsub.push.ActivationStateMachine;
import io.ably.pubsub.push.ActivationStateMachine.AfterRegistrationSyncFailed;
...
import io.ably.pubsub.push.ActivationStateMachine.NotActivated;
import io.ably.pubsub.push.ActivationStateMachine.RegistrationSynced;
import io.ably.pubsub.push.ActivationStateMachine.State;
import io.ably.pubsub.push.ActivationStateMachine.SyncRegistrationFailed;
import io.ably.pubsub.push.ActivationStateMachine.WaitingForDeregistration;
import io.ably.pubsub.push.ActivationStateMachine.WaitingForDeviceRegistration;
import io.ably.pubsub.push.ActivationStateMachine.WaitingForNewPushDeviceDetails;
import io.ably.pubsub.push.ActivationStateMachine.WaitingForPushDeviceDetails;
import io.ably.pubsub.push.ActivationStateMachine.WaitingForRegistrationSync;
...
import io.ably.pubsub.test.RetryTestRule;
...
import io.ably.pubsub.test.util.TestCases;
...
import io.ably.pubsub.types.RegistrationToken;
import io.ably.pubsub.util.Base64Coder;
import io.ably.pubsub.util.IntentUtils;
import io.ably.pubsub.util.JsonUtils;
...
import static io.ably.pubsub.test.common.Helpers.assertArrayUnorderedEquals;
import static io.ably.pubsub.test.common.Helpers.assertInstanceOf;
import static io.ably.pubsub.test.common.Helpers.assertSize;
import static io.ably.pubsub.util.Serialisation.gson;
...
public class AndroidPushTest {
    ...
    public void push_clientId_from_server() throws InterruptedException, AblyException {
        ...
        try {
            ...
            activation.adminHttp.push.admin.deviceRegistrations.remove(activation.rest.device().id);
        }
    ...
    public void PushChannel_listSubscriptions() throws Exception {
        class TestCase extends TestCases.Base {
            ...
            public void run() throws Exception {
                ...
                try {
                    testActivation.adminHttp.push.admin.deviceRegistrations.save(otherDevice);

                    for (PushBase.ChannelSubscription sub : fixtures) {
                        testActivation.adminHttp.push.admin.channelSubscriptions.save(sub);
                    }
                    ...
                    testActivation.adminHttp.push.admin.deviceRegistrations.remove(otherDevice);
                    for (PushBase.ChannelSubscription sub : fixtures) {
                        testActivation.adminHttp.push.admin.channelSubscriptions.remove(sub);
                    }
                }
            }
        }
