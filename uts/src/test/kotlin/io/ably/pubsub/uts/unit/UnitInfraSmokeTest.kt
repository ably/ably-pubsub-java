package io.ably.pubsub.uts.unit
...
import io.ably.pubsub.uts.infra.unit.CONNECTED_MESSAGE
...
import io.ably.pubsub.uts.infra.unit.PendingConnection
...
class UnitInfraSmokeTest {
     ...
     * ([io.ably.pubsub.uts.infra.unit.WebSocketMockConfig.onConnectionAttempt]) for the WebSocket, and
     ...
     * assert via [MockHttpClient.awaitRequest] / the [io.ably.pubsub.uts.infra.unit.PendingRequest]
     * instead.
     */
    @Test
