...
import io.ably.pubsub.transport.ITransport.ConnectListener;
import io.ably.pubsub.transport.ITransport.TransportParams;
import io.ably.pubsub.transport.NetworkConnectivity.NetworkConnectivityListener;
import io.ably.pubsub.types.AblyException;
import io.ably.pubsub.types.Callback;
import io.ably.pubsub.types.ClientOptions;
import io.ably.pubsub.types.ConnectionDetails;
...
public class ConnectionManager implements ConnectListener {
    ...
    /**
     * Methods on the channels map owned by the {@link RealtimeClient} instance
    ...
    public ConnectionManager(final RealtimeClient ably, final Connection connection, final Channels channels, final PlatformAgentProvider platformAgentProvider, LiveObjectsPlugin liveObjectsPlugin) throws AblyException {
        this.ably = ably;
