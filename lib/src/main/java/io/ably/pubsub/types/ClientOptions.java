...
/**
 * Passes additional client-specific properties to the {@link io.ably.pubsub.http.PubSubHttpClient} or the {@link io.ably.pubsub.realtime.RealtimeClient}.
 * <p>
...
public class ClientOptions extends AuthOptions {
    ...
    /**
     * Creates a ClientOptions instance used to configure HTTP and Realtime clients
     */
     ...
     * {@link io.ably.pubsub.realtime.Connection#connect} method. The default is true.
     * <p>
     * Spec: RTC1b, TO3e
     */
     ...
     * defaults when issuing new Ably Tokens or Ably {@link io.ably.pubsub.http.Auth.TokenRequest}.
     * <p>
     * Spec: TO3j11
     */
    ...
    /**
     * When a channel becomes {@link io.ably.pubsub.realtime.ChannelState#suspended}
     * following a server initiated {@link io.ably.pubsub.realtime.ChannelState#detached},
     * after this delay, if the channel is still {@link io.ably.pubsub.realtime.ChannelState#suspended}
     * and the connection is {@link io.ably.pubsub.realtime.ConnectionState#connected},
