...
public class Presence {
     ...
     * such as their {@link io.ably.pubsub.types.PresenceMessage.Action} and ID.
    ...
    private static class Multicaster extends io.ably.pubsub.util.Multicaster<PresenceListener> implements PresenceListener {
        @Override
    ...
    public void updatePresence(PresenceMessage msg, CompletionListener listener) throws AblyException {
        ...
        RealtimeClient ably = channel.ably;
