...
/**
 * A client that extends the functionality of the {@link PubSubHttpClient} and provides additional realtime-specific features.
 *
 ...
 */
public class RealtimeClient extends PubSubHttpClient {
    /**
    ...
    private class InternalChannels extends InternalMap<String, Channel> implements Channels, ConnectionManager.Channels {
        ...
        public Channel get(final String channelName, final ChannelOptions channelOptions) throws AblyException {
            ...
            final Channel newChannel = new Channel(RealtimeClient.this, channelName, channelOptions, liveObjectsPlugin);
    ...
    private static final String TAG = RealtimeClient.class.getName();
}
