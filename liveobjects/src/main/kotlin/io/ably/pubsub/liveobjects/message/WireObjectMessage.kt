package io.ably.pubsub.liveobjects.message
...
import io.ably.pubsub.liveobjects.byteSize
import io.ably.pubsub.liveobjects.serialization.WireObjectDataJsonSerializer
 ...
 *
 * Copied from the legacy internal model (`io.ably.pubsub.objects.ObjectMessage`)
 * so that this package has no dependency on `io.ably.pubsub.objects`. The `Wire`
 * prefix distinguishes these internal carriers from the public interfaces in
 * `io.ably.pubsub.object.message`.
 *
