...
import io.ably.pubsub.liveobjects.instance.InstanceListener
...
import io.ably.pubsub.liveobjects.path.PathObject
import io.ably.pubsub.liveobjects.path.PathObjectListener
import io.ably.pubsub.liveobjects.path.PathObjectSubscriptionEvent
import io.ably.pubsub.liveobjects.path.PathObjectSubscriptionOptions
import io.ably.pubsub.liveobjects.path.types.LiveMapPathObject
import io.ably.pubsub.liveobjects.state.ObjectStateChange
...
class RealtimeObjectTest {
    ...
    private fun RealtimeClient.objectsChannel(
        name: String,
